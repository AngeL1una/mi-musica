        ...
        <div className="grid grid-cols-6 md:grid-cols-12 gap-6 md:gap-4 items-center justify-center">
          <div className="relative col-span-6 md:col-span-4">
            <Image
              ...
              height={200}
              shadow="md"
              src="https://images7.alphacoders.com/109/1098556.png"
              width="100%"
            />
          </div>
          ...
          <div className="flex flex-col col-span-6 md:col-span-8">
            <div className="flex justify-between items-start">
              <div className="flex flex-col gap-0">
                <h3 className="font-semibold text-foreground/90">JOJI</h3>
                <p className="text-small text-foreground/80">NECTAR</p>
                <h1 className="text-large font-medium mt-2">Like You Do</h1>
              </div>
              <Button
                isIconOnly
